/*! this is a compiled file do not change austin2040.core - v0.1.0 - 2019-09-15 */
(function() {
var i = 0;
...
Blaze.dna.Game = Blaze.Application.extend({
  ...
  createViews: function() {
    ...
    this.addView("start", new Blaze.dna.StartScreen(), "#GameFrame", {
  ...
  adjustPopulation: function() {
    this.triggerGlobal(
      "game:adjustPopulation",
      this.gameModel.get("population")
    );
  ...
  selectSolution: function(solution) {
    ...
    if (this.showTimer) this.getView("timer").stopTimer();
